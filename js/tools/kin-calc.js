...
window.initKinCalc = function(container) {
    ...
    var KIN = {
        ...
        '表侄':   { name: '表侄',   aliases: ['表侄子'], sex: '男', desc: '表兄弟/表姐妹的儿子' },
        '表侄女': { name: '表侄女', aliases: [], sex: '女', desc: '表兄弟/表姐妹的女儿' },
        '堂侄':   { name: '堂侄',   aliases: ['堂侄子'], sex: '男', desc: '堂兄弟/堂姐妹的儿子' },
        '堂侄女': { name: '堂侄女', aliases: [], sex: '女', desc: '堂兄弟/堂姐妹的女儿' }
    };
    ...
    var RULES = {
        ...
        '外孙女>爸爸': '女儿', '外孙女>妈妈': '女婿',
        // 表侄系
        '表兄弟>儿子': '表侄', '表兄弟>女儿': '表侄女',
        '表姐妹>儿子': '表侄', '表姐妹>女儿': '表侄女',
        '堂兄弟>儿子': '堂侄', '堂兄弟>女儿': '堂侄女',
        '堂姐妹>儿子': '堂侄', '堂姐妹>女儿': '堂侄女',
        // 配偶系
        '丈夫>爸爸': '公公', '丈夫>妈妈': '婆婆',
        '丈夫>哥哥': '大伯子', '丈夫>弟弟': '小叔子',
        '丈夫>姐姐': '大姑子', '丈夫>妹妹': '小姑子',
